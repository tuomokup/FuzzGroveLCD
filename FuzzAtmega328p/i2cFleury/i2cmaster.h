...
extern unsigned char INSTRUCTIONset(uint8_t addre, uint8_t ADset, uint8_t command);

extern void Print(uint8_t addre, char *str);

extern unsigned int read_adc(uint8_t channel);
